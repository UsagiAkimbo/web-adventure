...
async function parseHTML(url) {
    try {
        ...
        if (url.endsWith('tutorial.html')) {
            return {
                terrainComplexity: Math.min(tagCounts.div, 10), // Keep terrain simple
                waterComplexity: 0, // No water
                isAquatic: false, // Non-aquatic
                resources: 1, // Exactly 1 resource (override img count)
                enemies: 0, // No enemies
                animals: 0, // No animals
                animalTypeFactor: 0,
                structures: 0, // No structures
                interactables: 0, // No interactables
                obstacles: 0, // No obstacles
                paths: 0, // No paths
                atmosphere: Math.min(tagCounts.meta, 5), // Minimal fog
                collectibles: 0, // No collectibles
                vegetation: 0, // No vegetation
                hazards: 0 // No hazards
            };
        }
